        ...
        <div class="cuerpo" style="heigh=350px">
            ...
            <div class="formulario">
                <form name="porLector" method="post" action="#">
                    <fieldset> 
                   <legend>Estadisticas por lector</legend>
                 
    				<table>
                        <tr>
                        	<td>
                            	<label class="label">Id Lector</label></td><td><input class="texto" type="text" name="co_lector"/>
                        ...
                        <tr>
                        	<table border='1'  align="center">
                                ...
                                <?php
									...
									if(isset($_REQUEST["co_lector"]))
										Estadistica::porLector($mysqli,$_REQUEST["co_lector"]);	
