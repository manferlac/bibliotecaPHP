	...
	<div class="general">
        ...
        <div class="cuerpo" style="heigh=350px">
            ...
            <div class="formulario">
                <form name="altalibro" method="post" action="modulos/insertarPrestamoModulo.php">
                    <fieldset> 
                   <legend>Prestamos</legend>
                    ...
                    <tr>
                        ...
                        <tr>
                        	<td><label class="label">Fecha</label></td><td><input disabled="disabled" class="texto" type="text" value="<?php echo date("Y-m-j") ?>" name="fecha"/></td>
                        </tr>
                        <tr>
                        	<td colspan="4">
                            	<input class="botones" type="submit" name="enviar" value="Crear Prestamo" style="width:120px;" />
