	...
	<div class="general">
        ...
        <div class="cuerpo" style="heigh=350px">
            ...
            <div class="formulario">
                <form name="generales1" method="post" action="#">
                
                    <fieldset> 
                   <legend>Estadisticas generales de libros</legend>
                    ...
                    <tr>
                        ...
                        <tr>
                        	<table border='1'  align="center">
                            	<tr>
                                	<td>Titulo libro</td><td>Cantidad de veces  prestado</td>
                                </tr>
                                <tr>
                                <?php
									require "conexion/conexion.php";
										Estadistica::porLibroGenerales($mysqli);									
								?>
                                </tr>
							</table>
                        </tr>
